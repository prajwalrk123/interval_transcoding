...
#define CMDLINE_PARSER_PACKAGE "interval_transcoding"
#endif

#ifndef CMDLINE_PARSER_PACKAGE_NAME
/** @brief the complete program name (used for help and version) */
#define CMDLINE_PARSER_PACKAGE_NAME "interval_transcoding"
#endif
...
struct args
{
  ...
  char * input_arg;	/**< @brief Input stream/file URL.  */
  char * input_orig;	/**< @brief Input stream/file URL original value given at command line.  */
  const char *input_help; /**< @brief Input stream/file URL help description.  */
  char * output_arg;	/**< @brief Output stream server/file URL.  */
  char * output_orig;	/**< @brief Output stream server/file URL original value given at command line.  */
  const char *output_help; /**< @brief Output stream server/file URL help description.  */
  int v_bitrate_arg;	/**< @brief Output video bitrate, bits per second (default='0').  */
  char * v_bitrate_orig;	/**< @brief Output video bitrate, bits per second original value given at command line.  */
  const char *v_bitrate_help; /**< @brief Output video bitrate, bits per second help description.  */
